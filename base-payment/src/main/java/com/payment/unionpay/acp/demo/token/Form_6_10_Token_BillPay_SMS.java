...
public class Form_6_10_Token_BillPay_SMS  extends HttpServlet  {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		contentData.put("bussCode", bussCode);
		//先查询后缴费的交易，需上送查询交易应答的queryId
		contentData.put("origQryId", origQryId);
		...
		if(!rspData.isEmpty()){
			if(AcpService.validate(rspData, DemoBase.encoding)){
				...
				if(("00").equals(respCode)){
					//成功
					//TODO
					String respJson = "{\"respCode\":\""+respCode+"\"}";
