...
public class Form05_3_4_ApplyJFQrCode extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		contentData.put("txnType", "13");              		 	//交易类型 13:消费
		contentData.put("txnSubType", "08");           		 	//交易子类 08：申请缴费消费二维码
		contentData.put("bizType", "000000");          		 	//填写000000
		contentData.put("channelType", "08");          		 	//渠道类型 08手机
		contentData.put("bussCode", "D1_3300_0000");                 //缴费业务代码busscode 三元组：账单类型_地区码_附加地区码
