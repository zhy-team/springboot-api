 ...
 * 
 * 产品：代收产品<br>
 * 交易：代收(上送bindId代替卡号做代收)：后台资金类交易，有同步应答和后台通知应答<br>
 * 日期： 2015-09<br>
 ...
 */
public class Form09_6_2_DaiShou_BindId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		contentData.put("bindId", bindId);                     			//填写 做带绑定号的实名认证交易（Form09_6_9_RealAuth_Back_BindId/Front_BindId）成功绑定后的绑定号
