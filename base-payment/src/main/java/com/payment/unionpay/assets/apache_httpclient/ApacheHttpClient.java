package com.payment.unionpay.assets.apache_httpclient;
...
public class ApacheHttpClient {
	...
	public static void main(String[] args) throws Exception {
		...
		//com.payment.unionpay.acp.sdk.HttpClient hc = new com.payment.unionpay.acp.sdk.HttpClient(url1,30000,30000);
