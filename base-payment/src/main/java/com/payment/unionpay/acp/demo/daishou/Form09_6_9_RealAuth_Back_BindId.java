 ...
 * 
 * 产品：代收产品<br>
 * 交易：实名认证(验证要素带绑定标识码)：后台交易，只有同步应答<br>
 * 日期： 2015-09<br>
 * 版权： 中国银联<br>
 ...
 * 交易说明:1）同步交易，以同步应答为准，不需要接收后台通知或发起交易状态查询交易
 *       2）后续代收可以使用绑定标识码支付（参见Form09_6_2_DaiShou_BindId.java)
 */
public class Form09_6_9_RealAuth_Back_BindId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String accNo = AcpService.encryptData("6221558812340000", DemoBase.encoding);  //【贷记卡】这里测试的时候使用的是测试卡号，正式环境请使用真实卡号
