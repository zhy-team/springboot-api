 ...
 * 必送：卡号、姓名、证件类型、证件号、手机号、短信验证码、商户代码、商户名称、用户号、代收款项、协议有效期、代收频率，选送：交易限额。
 */

public class Form09_6_6_QianYue_Back extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if(smsCode != null) customerInfoMap.put("smsCode", smsCode); //短信验证码
