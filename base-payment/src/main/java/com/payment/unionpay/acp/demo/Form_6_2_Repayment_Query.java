 ...
 */
public class Form_6_2_Repayment_Query extends HttpServlet{
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		data.put("bussCode", "J1_9800_0000_3");                  //信用卡还款
		...
		if(!rspData.isEmpty()){
			if(AcpService.validate(rspData, DemoBase.encoding)){
				...
				if(("00").equals(respCode)){
					...
					System.out.println(AcpService.base64Decode(billDetailInfo,DemoBase.encoding));
				}else{
					//其他应答码为失败请排查原因或做失败处理
					//TODO
				}
