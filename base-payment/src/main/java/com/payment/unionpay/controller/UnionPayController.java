...
public class UnionPayController {
    ...
    public AjaxResult execute(@RequestBody @Valid UnionPayInfo unionPayInfo) {
        ...
        /***商户接入参数***/
        requestData.put("merId", unionPayInfo.getMerId());    	          			  //商户号码，请改成自己申请的正式商户号或者open上注册得来的777测试商户号
        ...
        requestData.put("txnAmt", unionPayInfo.getTxnAmt());             			      //交易金额，单位分，不要带小数点
