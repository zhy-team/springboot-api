 ...
 *       
 */
public class Form09_6_7_RemoveBind extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		contentData.put("txnType", "74");                              //交易类型 75-查询绑定关系
		...
		/***绑定标识码相关字段***/
		contentData.put("accNo", accNo);				   			   //卡号必送，上送需要解除绑定的标识码关联的卡号
		contentData.put("bindId", bindId);			   	   	           //绑定标识码必送，上送需要解除绑定的标识码
