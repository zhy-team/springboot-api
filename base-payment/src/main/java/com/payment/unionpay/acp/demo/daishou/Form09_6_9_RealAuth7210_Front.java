...
public class Form09_6_9_RealAuth7210_Front  extends HttpServlet  {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		contentData.put("txnType", "72");                              //交易类型 12 实名认证
		contentData.put("txnSubType", "10");                           //交易子类型10
		contentData.put("bizType", "000501");                          //业务类型 代收产品
		contentData.put("channelType", "07");                          //渠道类型07-PC 08 WAP
		...
		contentData.put("reserved", "{checkFlag=11100}");              //必送，无特殊需求，默认送这个，不需要改动
